...
const WAREHOUSE_LEVELS = {
    1: { name: "Temel Depo", capacity: 500, cost: 0 },
    2: { name: "Küçük Depo", capacity: 1500, cost: 1000000 },
    3: { name: "Orta Depo", capacity: 4000, cost: 3000000 },
    4: { name: "Büyük Depo", capacity: 10000, cost: 7000000 },
    5: { name: "Dev Depo", capacity: 25000, cost: 15000000 },
    6: { name: "Mega Depo", capacity: 75000, cost: 30000000 },
    7: { name: "Ultra Depo", capacity: 200000, cost: 60000000 },
    8: { name: "Süper Depo", capacity: 500000, cost: 120000000 }
};
...
function calculateSaleTime(businessType, productCode, price, quality, maintenance, advertising = 0) {
    ...
    // Pahalı fiyatlara dengeli ceza
    if (priceMultiplier > 1) {
        // 2 kat fiyat = 1.62 kat süre, 3 kat fiyat = 2.16 kat süre
        priceMultiplier = Math.pow(priceMultiplier, 0.7);
